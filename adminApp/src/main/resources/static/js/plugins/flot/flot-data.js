...
$(function() {
    ...
    var plotObj = $.plot($("#flot-pie-chart-room"), data, {
        series: {
            pie: {
                show: true
            }
...
$(function() {
    ...
    var plotObj = $.plot($("#flot-pie-chart-pantry"), data, {
        series: {
            pie: {
                show: true
            }
...
$(function() {
    ...
    var plotObj = $.plot($("#flot-pie-chart-service"), data, {
        series: {
            pie: {
                show: true
            }
...
$(function() {
	var ticks = [[0, "Room"], [1, "Pantry"], [2, "Service"]];
    var barOptions = {
        series: {
            bars: {
                show: true,
